<template>
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap gap-2">
      <button v-for="range in ranges" :key="range" @click="fetchChart(range)" :class="[
...
export default {
  ...
  methods: {
    async fetchChart(range) {
      ...
      try {
        const res = await axios.get(`https://3af9049ebeaf.ngrok-free.app/api/v1/chart/${this.coin}/?hours=${hours}`)
